...
JAZZMIN_SETTINGS = {
    ...
    "site_icon": "base/img/favicon.png",
    ...
    "order_with_respect_to": ["Morningstar", "album", "blog", "forum", "poll",],
    ...
    "icons": {
        ...
        "album": "far fa-images", "album.photo": "far fa-image",
        ...
        "forum": "fa icofont-earth", "forum.message": "fa icofont-ui-message", "forum.room": "fa icofont-crown", "forum.topic": "fa icofont-slidshare",
        "poll": "fas fa-poll", "poll.question": "fas fa-question", "poll.choice": "fa icofont-file-text",
    },
